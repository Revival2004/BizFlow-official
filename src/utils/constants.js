...
export const ROLE_PERMISSIONS = {
  admin: {
    ...
    view_profits: true, manage_categories: true,
  },
  sales_manager: {
    view_dashboard: true, view_sales: true, create_sale: true, void_sale: true,
    ...
    view_profits: true, manage_categories: false,
  },
  cashier: {
    ...
    view_profits: false, manage_categories: false,
  },
  stock_manager: {
    ...
    view_profits: false, manage_categories: true,
  },
  accountant: {
