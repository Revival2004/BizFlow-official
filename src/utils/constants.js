...
export const ROLE_PERMISSIONS = {
  admin: {
    ...
    view_profits: true, manage_categories: true, manage_payments: true, manage_billing: true,
  },
  sales_manager: {
    view_dashboard: true, view_sales: true, create_sale: true, void_sale: true,
    ...
    view_profits: true, manage_categories: false, manage_payments: false, manage_billing: false,
  },
  cashier: {
    ...
    view_profits: false, manage_categories: false, manage_payments: false, manage_billing: false,
  },
  stock_manager: {
    ...
    view_profits: false, manage_categories: true, manage_payments: false, manage_billing: false,
  },
  accountant: {
